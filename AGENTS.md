...
- Live tests (real keys): `CLAWDBOT_LIVE_TEST=1 pnpm test:live` (CDog-only) or `LIVE=1 pnpm test:live` (includes provider live tests). Onboarding E2E: `pnpm test:e2e:onboard`.
