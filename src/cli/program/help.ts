...
const EXAMPLES = [
  [
    "cdog channels login --verbose",
    "Link personal WhatsApp Web and show QR + connection logs.",
  ],
  [
    'cdog message send --target +15555550123 --message "Hi" --json',
    "Send via your web session and print JSON result.",
  ],
  ["cdog gateway --port 18789", "Run the WebSocket Gateway locally."],
  ["cdog --dev gateway", "Run a dev Gateway (isolated state/config) on ws://127.0.0.1:19001."],
  ["cdog gateway --force", "Kill anything bound to the default gateway port, then start it."],
  ["cdog gateway ...", "Gateway control via WebSocket."],
  [
    'cdog agent --to +15555550123 --message "Run summary" --deliver',
    "Talk directly to the agent using the Gateway; optionally send the WhatsApp reply.",
  ],
  [
    'cdog message send --channel telegram --target @mychat --message "Hi"',
