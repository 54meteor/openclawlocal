...
const SANDBOX_EXAMPLES = {
  main: [
    ["cdog sandbox list", "List all sandbox containers."],
    ["cdog sandbox list --browser", "List only browser containers."],
    ["cdog sandbox recreate --all", "Recreate all containers."],
    ["cdog sandbox recreate --session main", "Recreate a specific session."],
    ["cdog sandbox recreate --agent mybot", "Recreate agent containers."],
    ["cdog sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["cdog sandbox list", "List all sandbox containers."],
    ["cdog sandbox list --browser", "List only browser containers."],
    ["cdog sandbox list --json", "JSON output."],
  ],
  recreate: [
    ["cdog sandbox recreate --all", "Recreate all containers."],
    ["cdog sandbox recreate --session main", "Recreate a specific session."],
    ["cdog sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["cdog sandbox recreate --browser --all", "Recreate only browser containers."],
    ["cdog sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["cdog sandbox explain", "Show effective sandbox config."],
    ["cdog sandbox explain --session agent:main:main", "Explain a specific session."],
    ["cdog sandbox explain --agent work", "Explain an agent sandbox."],
    ["cdog sandbox explain --json", "JSON output."],
  ],
} as const;
